...
urlpatterns = [
    ...
    # path('product/<pid>', views.category_page, name='cproduct'),
    ...
    # path('productredirect', views.product_redirect, name="product"),
    # path('productpage',views.category_product_page,name="cproduct"),
]
